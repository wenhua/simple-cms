(function() {
  var benchmark, coffeekup, coffeekup_compiled_template, coffeekup_string_template, coffeekup_template, data, eco, eco_template, ejs, ejs_template, haml, haml_template, haml_template_compiled, jade, jade_compiled_template, jade_template, log;
  ...
  this.run = function() {
    benchmark('CoffeeKup (precompiled)', function() {
      return coffeekup_compiled_template(data);
    });
    benchmark('Jade (precompiled)', function() {
      return jade_compiled_template(data);
    });
    benchmark('haml-js (precompiled)', function() {
      return haml_template_compiled(data);
    });
    benchmark('Eco', function() {
      return eco.render(eco_template, data);
    });
    console.log('\n');
    benchmark('CoffeeKup (function, cache on)', function() {
      return coffeekup.render(coffeekup_template, data, {
        cache: true
      });
    });
    benchmark('CoffeeKup (string, cache on)', function() {
      return coffeekup.render(coffeekup_string_template, data, {
        cache: true
      });
    });
    ...
    console.log('\n');
    benchmark('CoffeeKup (function, cache off)', function() {
      return coffeekup.render(coffeekup_template, data);
    });
    ...
    return benchmark('ejs (cache off)', function() {
      return ejs.render(ejs_template, {
        locals: data
      });
    });
